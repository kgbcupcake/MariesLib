 ...
 * {@link PersistenceProvider}): icons, bars and text. {@link ModuleRenderContext} enforces all three for every
 * module drawn through {@code MarieModuleSettings.withDisplaySettings}; a module that draws some of its content
 * some other way (raw {@code fillRect} pips, a hand-rolled HUD row, ...) checks the matching getter itself,
 * the same way icons already had to be checked by such modules before bars/text existed here.
 */
@ApiStatus.Internal
